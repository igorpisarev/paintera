...
public class PainteraShowContainer extends Application {
	...
	private static <I extends IntegerType<I> & NativeType<I>> void findMaxId(
		...
		final CachedCellImg<I, ?> img = isLabelMultiset ? (CachedCellImg<I, ?>) N5LabelMultisets.openLabelMultiset(reader, dataset) : (CachedCellImg<I, ?>) N5Utils.open(reader, dataset);
